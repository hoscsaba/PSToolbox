...
void CheckValve::Ini(double vini, double pstart, double dt_target){
	Ini(1);
}
...
double CheckValve::Get_dprop(string prop_string){
	double out=-1;
	...
	if (prop_string == "dt")
		...
		cout << endl
				<< "ERROR! Checkvalve::Get_dprop(prop_string), unknown input: prop_string=" << prop_string << endl;
