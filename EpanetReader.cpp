...
string name1xx;
// END OF TODO
      cons.push_back(new Connector(name1xx,edges[idxPipe], isFront, "Pressure", 1.e5, demand, true));
...
double demand = junctions[actualNodeIdx].Demand;
       // TODO: ADD name
      string name2x;   
      vector<int> idx_edge2x;
      idx_edge2x.push_back(0);
      idx_edge2x.push_back(1);
      // END OF TODO
      cons.push_back(new Connector(name2x,edges[connectingPipes[0]], isFronts[0], edges[connectingPipes[1]], isFronts[1], demand, true,idx_edge2x));
  ...
  for (int i = 0; i < junctions.size(); i++)
  {
    ...
    if (size == 1)
    {
      ...
      if (junctions[i].type == 0) //"free" end
      {
        ...
        string name0;
        // END OF TODO
        cons.push_back(new Connector(name0,edges[idx1], end1, "Velocity", 0, demand, false));
      ...
      if (junctions[i].type == 1) // reservoir
      {
        ...
        string name1;
        // END OF TODO
        cons.push_back(new Connector(name1,edges[idx1], end1, "Pressure", head, demand, false));
    ...
    if (size == 2)
    {
      ...
      // TODO: ADD name
      string name2;   
      vector<int> idx_edge2;
      idx_edge2.push_back(0);
      idx_edge2.push_back(1);
      // END OF TODO
      cons.push_back(new Connector(name2,edges[idx1], end1, edges[idx2], end2, demand, false, idx_edge2));
    ...
    if (size == 3)
    {
      ...
      double demand = junctions[i].Demand;
        // TODO: ADD name
      string name3;   
      vector<int> idx_edge3;
      idx_edge3.push_back(0);
      idx_edge3.push_back(1);
      idx_edge3.push_back(2);
      // END OF TODO
 cons.push_back(new Connector(name3,edges[idx1],end1,edges[idx2],end2,edges[idx3],end3,demand,false,idx_edge3));
